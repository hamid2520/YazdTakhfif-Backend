...
class Business(models.Model):
    ...
    lat_map = models.DecimalField(max_digits=10, decimal_places=8, blank=True, null=True, verbose_name='عرض موقعیت مکانی')
    lang_map = models.DecimalField(max_digits=10, decimal_places=8, blank=True, null=True, verbose_name='طول موقعیت مکانی')
