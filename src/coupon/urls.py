...
urlpatterns = [
                  ...
                  path("coupons/detail/<str:slug>/", CouponAPIView.as_view(), name="coupon_detail"),
                  path("coupons/", CouponAPIView.as_view(), name="coupon_list"),
                  path("line-coupons/<str:coupon_slug>/", LineCouponAPIView.as_view(), name="line_coupon_list"),
              ] + router.urls
