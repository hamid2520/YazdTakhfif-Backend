...
from .views import BasketViewSet, BasketDetailViewSet, ClosedBasketAPIView, PaidClosedBasketListAPIView, \
    ...
    UserBasketProductCount, CurrentUserBasketDetail, CurrentUserBasketLineCouponsCount
...
urlpatterns = [
                  ...
                  path("user-linecoupons-count/<slug:slug>/", CurrentUserBasketLineCouponsCount.as_view(),
                       name="user_linecoupons_count")
              ] + router.urls
